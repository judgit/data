...
class MODSpider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            ...
            'https://www.npa.go.jp/policies/budget/review/r2/R2-cyukankohyo01.html',
            'https://www.npa.go.jp/policies/budget/review/r2/R2-cyukankohyo_sinnki.html',
            'https://www.npa.go.jp/policies/budget/review/r2/R3-saishyukohyo_sinnki.html',
        ]
        for url in urls:
